...
- After /iscape:new-project (greenfield codebases) - updates codebase map as code evolves
...
6. Offer next steps (typically: /iscape:new-project or /iscape:plan-phase)
</process>
