...
Conditional extended thinking at workflow decision points. Activates when `features.thinking_partner: true` in `context/config.json` (default: false).
...
**Note:** This integration point will be added when /iscape:explore (#1729) lands.
