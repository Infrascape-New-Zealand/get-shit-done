...
|----------|---------------|---------------|-------|
| plan-phase | iscape-planner | iscape-plan-checker | Revision prompt via planner-revision.md |
| execute-phase | iscape-executor | iscape-verifier | Post-execution verification |
| discuss-phase | orchestrator | iscape-plan-checker | Inline revision by orchestrator |
