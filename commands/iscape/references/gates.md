...
Canonical gate types used across Iscape workflows. Every validation checkpoint maps to one of these four types.
...
- STATE.md in error state blocking /iscape:next
