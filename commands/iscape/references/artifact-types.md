# Iscape Artifact Types

This reference documents all artifact types in the Iscape planning taxonomy. Each type has a defined
...
- **Location**: `context/phases/XX-name/XX-CONTEXT.md`
...
- **Location**: `context/phases/XX-name/XX-YY-PLAN.md`
...
- **Location**: `context/phases/XX-name/XX-YY-SUMMARY.md`
...
- **Location**: `context/HANDOFF.json` + `context/phases/XX-name/.continue-here.md` (or spike/deliberation path)
...
- **Location**: `context/phases/XX-name/XX-DISCUSSION-LOG.md`
...
- **Location**: `context/spikes/SPIKE-NNN/`
...
- **Location**: `context/METHODOLOGY.md` (project-scoped, not phase-scoped)
