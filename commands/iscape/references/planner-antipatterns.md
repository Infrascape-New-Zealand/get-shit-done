...
> Reference file for iscape-planner agent. Loaded on-demand via `@` reference.
...
```markdown
<context>
@context/phases/01-foundation/01-01-SUMMARY.md
@context/phases/01-foundation/01-02-SUMMARY.md  <!-- Does Plan 02 actually need Plan 01's output? -->
@context/phases/01-foundation/01-03-SUMMARY.md  <!-- Chain grows, context bloats -->
</context>
```
...
@context/PROJECT.md
@context/STATE.md
@context/phases/01-foundation/01-01-SUMMARY.md  <!-- Uses User type defined in Plan 01 -->
</context>
```
