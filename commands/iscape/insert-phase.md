...
if [ $# -lt 2 ]; then
  ...
  echo "Usage: /iscape:insert-phase <after> <description>"
  echo "Example: /iscape:insert-phase 72 Fix critical auth bug"
  exit 1
fi
```
...
2. Insert new phase heading with (INSERTED) marker:
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (run /iscape:plan-phase {decimal_phase} to break down)
