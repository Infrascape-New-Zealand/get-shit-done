...
Spikes live in `context/spikes/` and integrate with Iscape commit patterns, state tracking,
...
Does not require `/iscape-new-project` — auto-creates `context/spikes/` if needed.
</objective>
...
<process>
Execute the spike workflow from @./workflows/spike.md end-to-end.
