...
<process>
Execute the spec-phase workflow from @./workflows/spec-phase.md end-to-end.
...
- User knows they can now run /iscape-discuss-phase which will load SPEC.md automatically
</success_criteria>
