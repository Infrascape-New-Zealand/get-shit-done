...
<objective>
Generate a developer behavioral profile from session analysis (or questionnaire) and produce artifacts (USER-PROFILE.md, /iscape:dev-preferences, CLAUDE.md section) that personalize Claude's responses.
