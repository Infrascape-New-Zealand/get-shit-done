...
---
<objective>
Auto-fix issues found by code review. Reads REVIEW.md from the specified phase, spawns iscape-code-fixer agent to apply fixes, and produces REVIEW-FIX.md summary.
...
Context files (CLAUDE.md, REVIEW.md, phase state) are resolved inside the workflow via `iscape-tools init phase-op` and delegated to agent via config blocks.
</context>

<process>
This command is a thin dispatch layer. It parses arguments and delegates to the workflow.

Execute the code-review-fix workflow from @./workflows/code-review-fix.md end-to-end.
...
- Agent spawning (iscape-code-fixer)
