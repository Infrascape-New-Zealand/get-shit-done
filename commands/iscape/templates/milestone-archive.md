...
This template is used by the complete-milestone workflow to create archive files in `context/milestones/`.
...
_For current project status, see context/ROADMAP.md_
...
- Save to `context/milestones/v{VERSION}-{NAME}.md`
- Example: `context/milestones/v1.0-mvp.md`
