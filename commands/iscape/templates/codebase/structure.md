...
Template for `context/codebase/STRUCTURE.md` - captures physical file organization.
...
│   └── iscape/        # Iscape-specific commands
...
- Purpose: Document templates for context/ files
...
**New Slash Command:**
- Primary code: `commands/iscape/commands/{command-name}.md`
