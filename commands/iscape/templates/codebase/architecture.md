...
Template for `context/codebase/ARCHITECTURE.md` - captures conceptual code organization.
...
1. User runs: `iscape new-project`
...
**State Management:**
- File-based: All state lives in `context/` directory
...
- Triggers: User runs `iscape <command>`
