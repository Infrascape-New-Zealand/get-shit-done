...
> **Note:** Planning methodology is in `agents/iscape-planner.md`.
> This template defines the PLAN.md output format that the agent produces.

Template for `context/phases/XX-name/{phase}-{plan}-PLAN.md` - executable phase plans optimized for parallel execution.
...
**Wave is pre-computed:** Wave numbers are assigned during `/iscape:plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
...
```markdown
<context>
@context/phases/03-features/03-01-SUMMARY.md  # Just because it's earlier
@context/phases/03-features/03-02-SUMMARY.md  # Reflexive chaining
</context>
```
...
<output>
After completion, create `context/phases/03-features/03-01-SUMMARY.md`
</output>
```
...
@context/PROJECT.md
@context/ROADMAP.md
@context/phases/03-features/03-01-SUMMARY.md
@context/phases/03-features/03-02-SUMMARY.md
</context>
...
<output>
After completion, create `context/phases/03-features/03-03-SUMMARY.md`
</output>
```
...
See `./templates/user-setup.md` for full schema and examples
...
See `./workflows/verify-phase.md` for verification logic.
