...
Template for `context/STATE.md` — the project's living memory.
...
See: context/PROJECT.md (updated [date])
...
[From context/todos/pending/ — ideas captured during sessions]
...
**Pending Todos:** Ideas captured via /iscape:add-todo
- Count of pending todos
- Reference to context/todos/pending/
- Brief list if few, count if many (e.g., "5 pending todos — see /iscape:check-todos")
