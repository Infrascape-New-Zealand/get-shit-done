...
Template for `context/phases/XX-name/{phase_num}-UAT.md` — persistent UAT session tracking.
...
- This section feeds directly into /iscape:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /iscape:plan-phase --gaps with root causes
...
**Creation:** When /iscape:verify-work starts new session
