...
Template for `context/debug/[slug].md` — active debug session tracking.
...
**Creation:** Immediately when /iscape:debug is called
...
**On resolution:**
- status → "resolved"
- Move file to context/debug/resolved/ (only after user confirms fix)
