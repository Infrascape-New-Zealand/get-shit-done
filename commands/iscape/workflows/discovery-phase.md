...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /iscape:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ./templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Quality check:** Before finalizing findings, consult ./references/research-pitfalls.md to avoid common research gaps.

7. **Create DISCOVERY.md** using ./templates/discovery.md structure:
...
6. **Quality check:** Before finalizing findings, consult ./references/research-pitfalls.md to ensure comprehensive coverage and avoid common research gaps.
...
1. Discuss phase context (/iscape:discuss-phase [current-phase])
2. Create phase plan (/iscape:plan-phase [current-phase])
