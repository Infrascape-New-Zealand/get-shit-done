...
Did you want to:
1. Complete current milestone first (/iscape:complete-milestone)
2. Add phases to current milestone (/iscape:add-phase)
...
- options (ALL THREE REQUIRED):
  - "Create milestone" - Proceed to /iscape:new-milestone
...
**Status:** Ready for /iscape:new-milestone
...
*This file is temporary. It will be deleted after /iscape:new-milestone creates the milestone.*
EOF
```
</step>
...
- Context handed off to /iscape:new-milestone
</success_criteria>
