<purpose>
Generate a UI design contract (UI-SPEC.md) for frontend phases. Orchestrates iscape-ui-researcher and iscape-ui-checker with a revision loop. Inserts between discuss-phase and plan-phase in the lifecycle.
...
```bash
INIT=$(node "$HOME/.claude/get-shit-done/bin/iscape-tools.cjs" init plan-phase "$PHASE")
...
```bash
UI_RESEARCHER_MODEL=$(node "$HOME/.claude/get-shit-done/bin/iscape-tools.cjs" resolve-model iscape-ui-researcher --raw)
UI_CHECKER_MODEL=$(node "$HOME/.claude/get-shit-done/bin/iscape-tools.cjs" resolve-model iscape-ui-checker --raw)
```

Check config:

```bash
UI_ENABLED=$(node "$HOME/.claude/get-shit-done/bin/iscape-tools.cjs" config-get workflow.ui_phase 2>/dev/null || echo "true")
```

**If `UI_ENABLED` is `false`:**
```
UI phase is disabled in config. Enable via /iscape:settings.
```
Exit workflow.
...
```bash
PHASE_INFO=$(node "$HOME/.claude/get-shit-done/bin/iscape-tools.cjs" roadmap get-phase "${PHASE}")
```
...
Recommended: run /iscape:discuss-phase {N} first to capture design preferences.
...
## 5. Spawn iscape-ui-researcher

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Iscape ► UI DESIGN CONTRACT — PHASE {N}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```markdown
Read ~/.claude/agents/iscape-ui-researcher.md for instructions.
...
- {context_path} (USER DECISIONS from /iscape:discuss-phase)
...
## 7. Spawn iscape-ui-checker

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Iscape ► VERIFYING UI-SPEC
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```markdown
Read ~/.claude/agents/iscape-ui-checker.md for instructions.
...
- Re-spawn iscape-ui-researcher with revision context:
...
2. Edit manually — open UI-SPEC.md in editor, re-run /iscape:ui-phase
...
```bash
node "$HOME/.claude/get-shit-done/bin/iscape-tools.cjs" commit "docs(${padded_phase}): UI design contract" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-SPEC.md"
```
...
- [ ] iscape-ui-researcher spawned with correct context and file paths
- [ ] UI-SPEC.md created in correct location
- [ ] iscape-ui-checker spawned with UI-SPEC.md
