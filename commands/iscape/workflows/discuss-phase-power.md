...
<trigger>
This workflow executes when `--power` flag is present in ARGUMENTS to `/iscape:discuss-phase`.
...
Consider running /iscape:discuss-phase {N} again to refine before planning.
```
