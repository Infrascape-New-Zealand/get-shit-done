...
Users currently hand-craft `/iscape:quick` prompts for test generation after each phase. This workflow standardizes the process with proper classification, quality gates, and gap reporting.
</purpose>
...
Example: `/iscape:add-tests 12 focus on edge cases` → `$PHASE_ARG=12`, `$EXTRA_INSTRUCTIONS="focus on edge cases"`

If no phase argument provided:

```
ERROR: Phase number required
Usage: /iscape:add-tests <phase> [additional instructions]
Example: /iscape:add-tests 12
Example: /iscape:add-tests 12 focus on edge cases in the pricing module
```
...
```bash
INIT=$(node ./bin/iscape-tools.cjs init phase-op "${PHASE_ARG}")
```
...
Ensure the phase exists in context/phases/
```
Exit.
...
This command works on completed phases. Run /iscape:execute-phase first.
```
Exit.
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Iscape ► ADD TESTS — Phase ${phase_number}: ${phase_name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
</step>
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Iscape ► TEST GENERATION COMPLETE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```bash
node ./bin/iscape-tools.cjs state-snapshot
```
...
{if bugs discovered:}
**Fix discovered bugs:** `/iscape:quick fix the {N} test failures discovered in phase ${phase_number}`
...
**Also available:**
- `/iscape:add-tests {next_phase}` — test another phase
- `/iscape:verify-work {phase_number}` — run UAT verification
