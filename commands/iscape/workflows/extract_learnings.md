...
- `context/STATE.md` — project state with decisions and blockers
...
```bash
iscape-sdk query state.update "Last Activity" "$(date +%Y-%m-%d)"
```
</step>
