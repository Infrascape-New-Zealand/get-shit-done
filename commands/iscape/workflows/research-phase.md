...
Triggered by /iscape:research-phase command when the domain is niche, complex, or Claude's training is likely stale.
...
**From ./references/research-pitfalls.md:**
...
What's next?
1. Plan this phase (/iscape:plan-phase ${PHASE}) - RESEARCH.md will be loaded automatically
...
When /iscape:plan-phase runs after research:
