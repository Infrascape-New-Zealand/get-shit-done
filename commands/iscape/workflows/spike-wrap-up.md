...
for future build conversations. Reads from `context/spikes/`, writes skill to
`./.claude/skills/spike-findings-[project]/` (project-local) and summary to
`context/spikes/WRAP-UP-SUMMARY.md`. Companion to `/iscape-spike`.
</purpose>
...
1. Read `context/spikes/MANIFEST.md` for the overall idea context and requirements
2. Glob `context/spikes/*/README.md` and parse YAML frontmatter from each
...
```
No unprocessed spikes found in `context/spikes/`.
Run `/iscape-spike` first to create experiments.
```
Exit.
...
Write `context/spikes/WRAP-UP-SUMMARY.md` for project history:
...
Analyze all processed spikes for recurring patterns and write `context/spikes/CONVENTIONS.md`. This file tells future spike sessions *how we spike* — the stack, structure, and patterns that have been established.
...
2. Write or update `context/spikes/CONVENTIONS.md`:
...
```bash
iscape-sdk query commit "docs(spike-wrap-up): package [N] spike findings into project skill" --files context/spikes/WRAP-UP-SUMMARY.md context/spikes/CONVENTIONS.md
```
</step>
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Iscape ► SPIKE WRAP-UP COMPLETE ✓
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

**Processed:** {N} spikes
**Feature areas:** {list}
**Skill:** `./.claude/skills/spike-findings-[project]/`
**Conventions:** `context/spikes/CONVENTIONS.md`
**Summary:** `context/spikes/WRAP-UP-SUMMARY.md`
...
`/iscape-spike` (run with no argument — its frontier mode analyzes the spike landscape and proposes integration and frontier spikes)

───────────────────────────────────────────────────────────────

**Also available:**
- `/iscape-plan-phase` — start planning the real implementation
- `/iscape-spike [idea]` — spike a specific new idea
- `/iscape-explore` — continue exploring
- Other
...
- [ ] `context/spikes/CONVENTIONS.md` created or updated with recurring stack/structure/pattern choices
- [ ] `context/spikes/WRAP-UP-SUMMARY.md` written for project history
- [ ] Project CLAUDE.md has auto-load routing line
- [ ] Summary presented
- [ ] Next-step options presented (including frontier spike exploration via `/iscape-spike`)
</success_criteria>
