...
- Any {phase}-RESEARCH.md (from /iscape:research-phase)
- Any DISCOVERY.md (from mandatory discovery)
- Any {phase}-CONTEXT.md (from /iscape:discuss-phase)
...
**If neither exist:** Suggest /iscape:research-phase for niche domains, /iscape:discuss-phase for simpler domains, or proceed with roadmap only.
</step>
...
**TDD candidates get dedicated plans.** If "Create price calculator with discount rules" warrants TDD, create a TDD plan for it. See `./references/tdd.md` for TDD plan structure.
</task_quality>
