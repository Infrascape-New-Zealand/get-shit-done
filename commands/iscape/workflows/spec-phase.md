...
If "Skip": Exit with message: "Existing SPEC.md unchanged. Run /iscape-discuss-phase [X] to continue."
...
Use the SPEC.md template from @./templates/spec.md.
...
- User directed to /iscape-discuss-phase as next step
</success_criteria>
