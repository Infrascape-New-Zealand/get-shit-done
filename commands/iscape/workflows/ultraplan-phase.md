...
intentionally isolated from /iscape-plan-phase so upstream changes to ultraplan cannot
...
```text
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Iscape ► ULTRAPLAN PHASE  ⚠ BETA
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Ultraplan is in research preview (Claude Code v2.1.91+).
Use /iscape-plan-phase for stable local planning.
```
...
/iscape-ultraplan-phase requires Claude Code.
ultraplan is not available in this runtime.

Use /iscape-plan-phase for local planning instead.
```
...
unplanned phase from the roadmap (same logic as /iscape-plan-phase).

Load Iscape phase context:
...
Build the ultraplan prompt from Iscape context.
...
Produce a Iscape PLAN.md with the following YAML frontmatter:
...
When ◆ ultraplan ready appears in your terminal:
  ...
  7. Run: /iscape-import --from <the file path>

/iscape-import will run conflict detection, convert to Iscape format,
