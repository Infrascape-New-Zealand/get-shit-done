...
```bash
UI_AUDITOR_MODEL=$(node "$HOME/.claude/get-shit-done/bin/iscape-tools.cjs" resolve-model iscape-ui-auditor --raw)
```

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Iscape ► UI AUDIT — PHASE {N}: {name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
**If `SUMMARY_FILES` empty:** Exit — "Phase {N} not executed. Run /iscape:execute-phase {N} first."
...
```markdown
Read ~/.claude/agents/iscape-ui-auditor.md for instructions.
...
- `/iscape:verify-work {N}` — UAT testing
- `/iscape:plan-phase {N+1}` — plan next phase
...
```bash
node "$HOME/.claude/get-shit-done/bin/iscape-tools.cjs" commit "docs(${padded_phase}): UI audit review" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-REVIEW.md"
```
...
- [ ] iscape-ui-auditor spawned with correct context
