...
Use after /iscape-execute-phase to verify that the evaluation strategy from AI-SPEC.md was actually implemented. Mirrors the pattern of /iscape-ui-review and /iscape-validate-phase.
</purpose>
...
```bash
INIT=$(iscape-sdk query init.phase-op "${PHASE_ARG}")
...
```bash
AUDITOR_MODEL=$(iscape-sdk query resolve-model iscape-eval-auditor 2>/dev/null | jq -r '.model' 2>/dev/null || true)
```

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Iscape ► EVAL AUDIT — PHASE {N}: {name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
**State C** — No SUMMARY.md: Exit — "Phase {N} not executed. Run /iscape-execute-phase {N} first."
...
Consider running /iscape-ai-integration-phase {N} before implementation next time.
```
...
```markdown
Read ~/.claude/agents/iscape-eval-auditor.md for instructions.
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Iscape ► EVAL AUDIT COMPLETE — PHASE {N}: {name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
{If PRODUCTION READY:}
  Next step: /iscape-plan-phase (next phase) or deploy

{If NEEDS WORK:}
  Address critical gaps in EVAL-REVIEW.md, then re-run /iscape-eval-review {N}
...
- [ ] iscape-eval-auditor spawned with correct context
