...
**If MILESTONE-CONTEXT.md exists (from /iscape:discuss-milestone):**
...
Plans:
- [ ] [N]-01: TBD (run /iscape:plan-phase [N] to break down)
...
**Also available:**
- `/iscape:discuss-phase [N]` — gather context first
- `/iscape:research-phase [N]` — investigate unknowns
- Review roadmap
